...
"}")
        ...
        # self.lineEd、it.setClearButtonEnabled(True)
    ...
    def retranslateUi(self, Form):
        ...
        # self.lineEdit.setPlaceholderText(_translate("Form", "请输入您的IP地址："))
        ...
        self.lineEdit_3.setPlaceholderText(_translate("Form", "请输入您的ID："))
...
import views.LoginView.resource.resource_rc
